      ...
      !(function () {
        var t = {
            ...
            5251: function (t2, e2, r2) {
              ...
              var a =
                  l2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
                    .ReactCurrentOwner,
                i = Object.prototype.hasOwnProperty,
                s = { key: true, ref: true, __self: true, __source: true };
              function c(t3, e3, r3) {
                var l3,
                  n2 = {},
                  c2 = null,
                  u = null;
                for (l3 in (void 0 !== r3 && (c2 = "" + r3),
                void 0 !== e3.key && (c2 = "" + e3.key),
                void 0 !== e3.ref && (u = e3.ref),
                e3))
                  i.call(e3, l3) && !s.hasOwnProperty(l3) && (n2[l3] = e3[l3]);
                if (t3 && t3.defaultProps)
                  for (l3 in (e3 = t3.defaultProps))
                    void 0 === n2[l3] && (n2[l3] = e3[l3]);
                return {
                  $$typeof: o,
                  type: t3,
                  key: c2,
        ...
        (!(function () {
            ...
            return (h =
              ...
              function (t3) {
                for (var e3 = 1; e3 < arguments.length; e3++) {
                  var r2 = arguments[e3];
                  for (var l2 in r2)
                    Object.prototype.hasOwnProperty.call(r2, l2) &&
                      (t3[l2] = r2[l2]);
                }
                return t3;
          ...
          const _ = ({ socialNetwork: e3 }) => {
              ...
              return (0, y.jsx)("a", {
                target: "_blank",
                className: k()("ktl-social-item-module_social-item_LDEev", {
                  "ktl-social-item-module_social-item-dark-theme_ZhWgN":
                    "dark" === l2,
                }),
                href: e3.url,
                title: e3.title,
            ...
            b = () =>
              (0, y.jsx)("div", {
                className: "ktl-social-list-module_social-list_m5d4R",
                children: g.map((t3) =>
                  (0, y.jsx)(_, { socialNetwork: t3 }, t3.url),
                ),
              }),
            j = [
              {
          ...
          const z = ({ data: e3 }) => {
              const r2 = (0, x.useTextStyles)(),
                l2 = (0, t2.useTheme)();
              return (0, y.jsx)("li", {
                className: k()("ktl-nav-item-module_nav-item_526AM", {
                  "ktl-nav-item-module_nav-item-dark-theme__ymom": "dark" == l2,
                }),
                children: (0, y.jsx)("a", {
                  target: e3.isTargetBlank ? "_blank" : void 0,
                  href: e3.url,
                  title: e3.title,
                  className: k()(
                    r2("rs-text-2"),
                    r2("rs-link", { hardness: "average", mode: "nude" }),
                  ),
                  children: e3.title,
                }),
              });
            ...
            O = (t3) =>
              (0, y.jsx)("nav", {
                className: t3.className,
                children: (0, y.jsx)("ul", {
                  className: "ktl-nav-list-module_nav-list_2YPZ6",
                  children: j.map((t4) => (0, y.jsx)(z, { data: t4 }, t4.url)),
                }),
              });
          var M, N, E;
          function S() {
          ...
          const P = (t3) =>
              (0, y.jsx)("a", {
                ...
                target: "_blank",
                className: k()(t3.className, "ktl-logo-module_link_3Bppl"),
                children: (0, y.jsx)(A, {}),
              }),
            T = "ktl-footer-module_underlined-link_Pu1QP";
          var H = ({ forwardedRef: e3, className: r2 }) => {
            const l2 = (0, x.useTextStyles)(),
              o2 = (0, t2.useTheme)(),
              n2 = l2("rs-link", { hardness: "pale", mode: "nude" });
            return (0, y.jsxs)("footer", {
              className: k()("ktl-footer-module_footer_3ENKj", r2, {
                "ktl-footer-module_footer-dark-theme_1lVqh": "dark" === o2,
              }),
              ref: e3,
              children: [
                (0, y.jsxs)("div", {
                  className: "ktl-footer-module_social-list-area_3BpCr",
                  children: [
                    (0, y.jsx)("div", {
                      className: k()(
                        l2("rs-h4"),
                ...
                (0, y.jsx)(O, {
                  className: "ktl-footer-module_nav-list-area_11ftH",
                }),
                (0, y.jsxs)("div", {
                  className: k()(
                    l2("rs-text-3", { hardness: "pale" }),
                    "ktl-footer-module_text-area_1SpnS",
                  ),
                  children: [
                    (0, y.jsxs)("div", {
                      className: "ktl-footer-module_copyright_2uBX0",
                      children: [
                        "Kotlin\u2122 is\xA0protected under the",
                        " ",
                        (0, y.jsx)("a", {
                          className: k()(n2, T),
                          href: "https://kotlinlang.org/foundation/kotlin-foundation.html",
                          children: "Kotlin\xA0Foundation",
                        }),
                        " ",
                    ...
                    " ",
                    (0, y.jsxs)("div", {
                      className: "ktl-footer-module_motto_22kgv",
                      children: [
                        "Supported and developed by\xA0",
                        (0, y.jsx)("a", {
                          className: k()(n2, T),
                ...
                (0, y.jsx)(P, {
                  className: "ktl-footer-module_logo-area_24Dg6",
                }),
              ],
            });
          };
