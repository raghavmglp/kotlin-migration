var KotlinWebSiteUI = (() => {
  ...
  var require_shared_store = __commonJS({
    "node_modules/core-js/internals/shared-store.js"(exports, module) {
      ...
      var store = (module.exports =
        globalThis2[SHARED] || defineGlobalProperty(SHARED, {}));
    ...
    "node_modules/core-js/internals/array-iteration.js"(exports, module) {
      ...
      var createMethod = function (TYPE) {
        ...
        return function ($this, callbackfn, that) {
          ...
          var resIndex = 0;
          var target = IS_MAP
            ? arraySpeciesCreate($this, length)
            : IS_FILTER || IS_FILTER_REJECT
              ? arraySpeciesCreate($this, 0)
              : void 0;
          var value, result;
    ...
    "node_modules/core-js/modules/web.dom-collections.for-each.js"() {
      ...
      for (COLLECTION_NAME in DOMIterables) {
        if (DOMIterables[COLLECTION_NAME]) {
          handlePrototype(
            globalThis2[COLLECTION_NAME] &&
              globalThis2[COLLECTION_NAME].prototype,
          );
        }
      }
      var COLLECTION_NAME;
  ...
  var require_get_built_in2 = __commonJS({
    "node_modules/core-js-pure/internals/get-built-in.js"(exports, module) {
      ...
      module.exports = function (namespace, method) {
        return arguments.length < 2
          ? aFunction(path[namespace]) || aFunction(globalThis2[namespace])
  ...
  var require_export = __commonJS({
    "node_modules/core-js-pure/internals/export.js"(exports, module) {
      ...
      var createNonEnumerableProperty =
        require_create_non_enumerable_property2();
      var hasOwn = require_has_own_property2();
      ...
      module.exports = function (options, source) {
        ...
        var nativeSource = GLOBAL
          ...
          : STATIC
            ? globalThis2[TARGET]
            : globalThis2[TARGET] && globalThis2[TARGET].prototype;
        var target = GLOBAL
          ? path
          : path[TARGET] ||
  ...
  var require_get_own_property_descriptor = __commonJS({
    "node_modules/core-js-pure/es/object/get-own-property-descriptor.js"(
      ...
      var getOwnPropertyDescriptor = (module.exports =
        function getOwnPropertyDescriptor2(it, key) {
  ...
  var require_define_property = __commonJS({
    "node_modules/core-js-pure/es/object/define-property.js"(exports, module) {
      ...
      var path = require_path();
      var Object2 = path.Object;
      var defineProperty = (module.exports = function defineProperty2(
        it,
        key,
        desc,
      ) {
  ...
  var require_symbol_is_well_known = __commonJS({
    "node_modules/core-js-pure/internals/symbol-is-well-known.js"(
      ...
      for (
        i = 0,
          symbolKeys = getOwnPropertyNames(Symbol2),
  ...
  function _typeof(o) {
    ...
    return (
      (_typeof =
        "function" == typeof import_symbol.default &&
        "symbol" == typeof import_iterator.default
          ? function (o2) {
              return typeof o2;
            }
          : function (o2) {
              return o2 &&
                "function" == typeof import_symbol.default &&
                o2.constructor === import_symbol.default &&
                o2 !== import_symbol.default.prototype
                ? "symbol"
                : typeof o2;
            }),
      _typeof(o)
  ...
  function _defineProperty(e, r, t) {
    return (
      (r = toPropertyKey(r)) in e
        ? (0, import_define_property.default)(e, r, {
            value: t,
            enumerable: true,
            configurable: true,
            writable: true,
  ...
  function ownKeys(object, enumerableOnly) {
    ...
    if (import_get_own_property_symbols.default) {
      ...
      if (enumerableOnly) {
        symbols = (0, import_filter.default)(symbols).call(
          symbols,
          function (sym) {
            return (0, import_get_own_property_descriptor.default)(object, sym)
              .enumerable;
          },
        );
      }
  ...
  function _objectSpread(target) {
    for (var i = 1; i < arguments.length; i++) {
      ...
      if (i % 2) {
        ...
        Object.defineProperties(
          target,
          (0, import_get_own_property_descriptors.default)(source),
        );
      } else {
        ownKeys(Object(source)).forEach(function (key) {
          Object.defineProperty(
            target,
            key,
            (0, import_get_own_property_descriptor.default)(source, key),
          );
        });
      }
    }
  ...
  var import_web_dom_collections_for_each,
    import_keys,
    import_get_own_property_symbols,
    import_filter,
    import_get_own_property_descriptor,
    import_get_own_property_descriptors,
    import_es_function_name,
    import_react,
    LAYER_STEP,
  ...
  var init_layering_context = __esm({
    "node_modules/@rescui/ui-contexts/lib/parts/layering-context.js"() {
      import_web_dom_collections_for_each = __toESM(
        require_web_dom_collections_for_each(),
      );
      import_keys = __toESM(require_keys3());
      import_get_own_property_symbols = __toESM(
        require_get_own_property_symbols3(),
      );
      import_filter = __toESM(require_filter4());
      import_get_own_property_descriptor = __toESM(
        require_get_own_property_descriptor3(),
      );
      import_get_own_property_descriptors = __toESM(
        require_get_own_property_descriptors3(),
      );
      init_classCallCheck();
      init_defineProperty();
      ...
      LAYER_STEP = 500;
      LayeringContextValue = function LayeringContextValue2(
        baseZIndex,
        isInPortal,
      ) {
        var _this = this;
      ...
      LayeringContext = /* @__PURE__ */ (0, import_react.createContext)(
        new LayeringContextValue(0),
      );
        ...
        var component = function component2(props) {
          return /* @__PURE__ */ import_react.default.createElement(
            ...
            function (layering) {
              return /* @__PURE__ */ import_react.default.createElement(
                WrappedComponent,
                _objectSpread(_objectSpread({}, layering), props),
              );
            },
          );
        };
        component.displayName = "WithLayering(".concat(
      ...
      if (true) {
        (function () {
          ...
          var REACT_PORTAL_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.portal")
            : 60106;
          ...
          var REACT_PROFILER_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.profiler")
            : 60114;
          var REACT_PROVIDER_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.provider")
            : 60109;
          var REACT_CONTEXT_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.context")
            : 60110;
          var REACT_ASYNC_MODE_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.async_mode")
            : 60111;
          var REACT_CONCURRENT_MODE_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.concurrent_mode")
            : 60111;
          var REACT_FORWARD_REF_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.forward_ref")
            : 60112;
          var REACT_SUSPENSE_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.suspense")
            : 60113;
          var REACT_SUSPENSE_LIST_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.suspense_list")
            : 60120;
          var REACT_MEMO_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.memo")
            : 60115;
          var REACT_LAZY_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.lazy")
            : 60116;
          var REACT_BLOCK_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.block")
            : 60121;
          var REACT_FUNDAMENTAL_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.fundamental")
            : 60117;
          var REACT_RESPONDER_TYPE = hasSymbol
            ? /* @__PURE__ */ Symbol.for("react.responder")
            : 60118;
  ...
  function LayeringProvider(_ref) {
    ...
    var contextValue = (0, import_react2.useMemo)(
      function () {
        switch (baseLayer) {
          case "popup":
  ...
  var init_layering_provider = __esm({
    "node_modules/@rescui/ui-contexts/lib/layering-provider.js"() {
      ...
      LayeringProvider.propTypes = {
        baseLayer: import_prop_types.default.oneOf([
          "popup",
          "dropdown",
          "tooltip",
        ]),
  ...
  function _objectWithoutProperties(e, t) {
    ...
    if (import_get_own_property_symbols2.default) {
      ...
      for (r = 0; r < n.length; r++)
        ((o = n[r]),
          -1 === (0, import_index_of2.default)(t).call(t, o) &&
  ...
  var init_objectWithoutProperties = __esm({
    "node_modules/@babel/runtime-corejs3/helpers/esm/objectWithoutProperties.js"() {
      import_get_own_property_symbols2 = __toESM(
        require_get_own_property_symbols6(),
        1,
      );
  ...
  function ownKeys2(object, enumerableOnly) {
    ...
    if (import_get_own_property_symbols3.default) {
      ...
      if (enumerableOnly) {
        symbols = (0, import_filter2.default)(symbols).call(
          symbols,
          function (sym) {
            return (0, import_get_own_property_descriptor2.default)(object, sym)
              .enumerable;
          },
        );
      }
  ...
  function _objectSpread2(target) {
    for (var i = 1; i < arguments.length; i++) {
      ...
      if (i % 2) {
        ...
        Object.defineProperties(
          target,
          (0, import_get_own_property_descriptors2.default)(source),
        );
      } else {
        ownKeys2(Object(source)).forEach(function (key) {
          Object.defineProperty(
            target,
            key,
            (0, import_get_own_property_descriptor2.default)(source, key),
          );
        });
      }
    }
  ...
  var import_web_dom_collections_for_each2,
    import_keys2,
    import_get_own_property_symbols3,
    import_filter2,
    import_get_own_property_descriptor2,
    import_get_own_property_descriptors2,
    import_es_function_name2,
    import_react3,
    _excluded,
    ThemeContext,
    ThemeConsumer,
  ...
  var init_theme_context = __esm({
    "node_modules/@rescui/ui-contexts/lib/parts/theme-context.js"() {
      import_web_dom_collections_for_each2 = __toESM(
        require_web_dom_collections_for_each(),
      );
      import_keys2 = __toESM(require_keys3());
      import_get_own_property_symbols3 = __toESM(
        require_get_own_property_symbols3(),
      );
      import_filter2 = __toESM(require_filter4());
      import_get_own_property_descriptor2 = __toESM(
        require_get_own_property_descriptor3(),
      );
      import_get_own_property_descriptors2 = __toESM(
        require_get_own_property_descriptors3(),
      );
      init_defineProperty();
      ...
      withTheme = function withTheme2(wrappedComponent) {
        ...
        var ComponentWithTheme =
          /* @__PURE__ */ import_react3.default.forwardRef(
            function (_ref, ref) {
        ...
        ComponentWithTheme.displayName = "WithTheme(".concat(
          WrappedComponent.displayName || WrappedComponent.name,
          ")",
        );
  ...
  function typographyLight(el) {
    ...
    el.style.setProperty(
      "--rs-typography-text-link-hover-color",
      RS_COLOR_WHITE,
    );
  }
      ...
      !(function () {
        var e = {
            ...
            5251: function (e2, t2, n2) {
              ...
              var l =
                  r2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
                    .ReactCurrentOwner,
                s = Object.prototype.hasOwnProperty,
                u = { key: true, ref: true, __self: true, __source: true };
              function a(e3, t3, n3) {
                var r3,
                  i2 = {},
                  a2 = null,
                  c = null;
                for (r3 in (void 0 !== n3 && (a2 = "" + n3),
                void 0 !== t3.key && (a2 = "" + t3.key),
                void 0 !== t3.ref && (c = t3.ref),
                t3))
                  s.call(t3, r3) && !u.hasOwnProperty(r3) && (i2[r3] = t3[r3]);
        ...
        (!(function () {
          ...
          var e2,
            t2 = n(8955),
            o = n.n(t2),
            i = (init_lib(), __toCommonJS(lib_exports)),
            l = [],
            s = "ResizeObserver loop completed with undelivered notifications.";
          !(function (e3) {
            ((e3.BORDER_BOX = "border-box"),
              (e3.CONTENT_BOX = "content-box"),
              (e3.DEVICE_PIXEL_CONTENT_BOX = "device-pixel-content-box"));
          })(e2 || (e2 = {}));
          var u,
            a = function (e3) {
            ...
            v = function (e3) {
              ...
              var r2 =
                null ===
                  (n2 =
                    null === (t3 = e3) || void 0 === t3
                      ? void 0
                      : t3.ownerDocument) || void 0 === n2
                  ? void 0
                  : n2.defaultView;
            ...
            y = function (e3, t3) {
              if ((void 0 === t3 && (t3 = false), m.has(e3) && !t3))
                return m.get(e3);
              if (h(e3)) return (m.set(e3, x), x);
              var n2 = getComputedStyle(e3),
                r2 = f(e3) && e3.ownerSVGElement && e3.getBBox(),
                o2 = !b && "border-box" === n2.boxSizing,
                i2 = _.test(n2.writingMode || ""),
                l2 = !r2 && g.test(n2.overflowY || ""),
                s2 = !r2 && g.test(n2.overflowX || ""),
                u2 = r2 ? 0 : E(n2.paddingTop),
                c2 = r2 ? 0 : E(n2.paddingRight),
                v2 = r2 ? 0 : E(n2.paddingBottom),
                p2 = r2 ? 0 : E(n2.paddingLeft),
                y2 = r2 ? 0 : E(n2.borderTopWidth),
                T2 = r2 ? 0 : E(n2.borderRightWidth),
                O2 = r2 ? 0 : E(n2.borderBottomWidth),
                S2 = p2 + c2,
                k2 = u2 + v2,
                L2 = (r2 ? 0 : E(n2.borderLeftWidth)) + T2,
                R2 = y2 + O2,
                z2 = s2 ? e3.offsetHeight - R2 - e3.clientHeight : 0,
                N2 = l2 ? e3.offsetWidth - L2 - e3.clientWidth : 0,
                j2 = o2 ? S2 + L2 : 0,
                C2 = o2 ? k2 + R2 : 0,
                M2 = r2 ? r2.width : E(n2.width) - j2 - N2,
                A2 = r2 ? r2.height : E(n2.height) - C2 - z2,
                B2 = M2 + S2 + N2 + L2,
                I2 = A2 + k2 + z2 + R2,
                P2 = a({
                  devicePixelContentBoxSize: w(
                    Math.round(M2 * devicePixelRatio),
                    Math.round(A2 * devicePixelRatio),
                    i2,
                  ),
                  borderBoxSize: w(B2, I2, i2),
                  contentBoxSize: w(M2, A2, i2),
                  contentRect: new d(p2, u2, M2, A2),
                });
            ...
            T = function (t3, n2, r2) {
              var o2 = y(t3, r2),
                i2 = o2.borderBoxSize,
                l2 = o2.contentBoxSize,
                s2 = o2.devicePixelContentBoxSize;
              switch (n2) {
            ...
            O = function (e3) {
              var t3 = y(e3);
              ((this.target = e3),
                (this.contentRect = t3.contentRect),
                (this.borderBoxSize = a([t3.borderBoxSize])),
                (this.contentBoxSize = a([t3.contentBoxSize])),
                (this.devicePixelContentBoxSize = a([
                  t3.devicePixelContentBoxSize,
                ])));
            },
            S = function (e3) {
              if (h(e3)) return 1 / 0;
              for (var t3 = 0, n2 = e3.parentNode; n2; )
                ((t3 += 1), (n2 = n2.parentNode));
              return t3;
            },
            k = function () {
              var e3 = 1 / 0,
              ...
              l.forEach(function (n3) {
                if (0 !== n3.activeTargets.length) {
                  ...
                  (n3.activeTargets.forEach(function (t4) {
                    var n4 = new O(t4.target),
                      o2 = S(t4.target);
                    (r3.push(n4),
                      (t4.lastReportedSize = T(t4.target, t4.observedBox)),
                      o2 < e3 && (e3 = o2));
                  }),
                    t3.push(function () {
            ...
            L = function (e3) {
              l.forEach(function (t3) {
                (t3.activeTargets.splice(0, t3.activeTargets.length),
                  t3.skippedTargets.splice(0, t3.skippedTargets.length),
                  t3.observationTargets.forEach(function (n2) {
                    n2.isActive() &&
                      (S(n2.target) > e3
                        ? t3.activeTargets.push(n2)
                        : t3.skippedTargets.push(n2));
                  }));
              });
            },
            R = function () {
              ...
              return (
                l.some(function (e4) {
                  ...
                  ("function" == typeof ErrorEvent
                    ? (e3 = new ErrorEvent("error", { message: s }))
                    : ((e3 = document.createEvent("Event")).initEvent(
                        "error",
                        false,
                        false,
                      ),
              ...
              return (
                ...
                (e3.prototype.observe = function () {
                  var e4 = this,
                    t3 = function () {
                      return (
                        e4.observer && e4.observer.observe(document.body, C)
                      );
                    };
                  document.body
                    ? t3()
                    : p.addEventListener("DOMContentLoaded", t3);
                }),
            ...
            U = (function () {
              function t3(t4, n2) {
                ((this.target = t4),
                  (this.observedBox = n2 || e2.CONTENT_BOX),
                  (this.lastReportedSize = { inlineSize: 0, blockSize: 0 }));
              }
              return (
                (t3.prototype.isActive = function () {
                  var e3,
                    t4 = T(this.target, this.observedBox, true);
                  return (
                    (e3 = this.target),
                    f(e3) ||
                      (function (e4) {
                      ...
                      "inline" !== getComputedStyle(e3).display ||
                      (this.lastReportedSize = t4),
                    this.lastReportedSize.inlineSize !== t4.inlineSize ||
                      this.lastReportedSize.blockSize !== t4.blockSize
                  );
                }),
                t3
              );
            ...
            F = function (e3, t3) {
              for (var n2 = 0; n2 < e3.length; n2 += 1)
                if (e3[n2].target === t3) return n2;
              return -1;
            },
            W = (function () {
              function e3() {}
              return (
                (e3.connect = function (e4, t3) {
                  var n2 = new D(e4, t3);
                  H.set(e4, n2);
                }),
                (e3.observe = function (e4, t3, n2) {
                  var r2 = H.get(e4),
                    o2 = 0 === r2.observationTargets.length;
                  F(r2.observationTargets, t3) < 0 &&
                    (o2 && l.push(r2),
                    r2.observationTargets.push(new U(t3, n2 && n2.box)),
                    P(1),
                    I.schedule());
                }),
                (e3.unobserve = function (e4, t3) {
                  var n2 = H.get(e4),
                    r2 = F(n2.observationTargets, t3),
                    o2 = 1 === n2.observationTargets.length;
                  r2 >= 0 &&
                    (o2 && l.splice(l.indexOf(n2), 1),
                    n2.observationTargets.splice(r2, 1),
                    P(-1));
                }),
            ...
            V = (function () {
              ...
              return (
                (e3.prototype.observe = function (e4, t3) {
                  if (0 === arguments.length)
                    throw new TypeError(
          ...
          var X = (e3) => {
            ...
            K = function (e3) {
              var t3 = [],
                ...
                r2 = function () {
                  for (
                    var r3 = arguments.length, o2 = new Array(r3), i2 = 0;
                    i2 < r3;
                    i2++
                  )
                    o2[i2] = arguments[i2];
                  ((t3 = o2),
                    n2 ||
                      (n2 = requestAnimationFrame(function () {
            ...
            ($ = (function () {
              ...
              return {
                ...
                subscribe(n2, r2) {
                  ...
                  t3.observe(n2);
                  const i2 =
                    null !== (o2 = e3.get(n2)) && void 0 !== o2 ? o2 : [];
                ...
                unsubscribe(n2, r2) {
                  ...
                  const i2 =
                    null !== (o2 = e3.get(n2)) && void 0 !== o2 ? o2 : [];
                  if (1 === i2.length)
                    return (t3.unobserve(n2), void e3.delete(n2));
          ...
          var re = function (e3) {
            ...
            oe = n(4184),
            ie = n.n(oe),
            le = (init_lib4(), __toCommonJS(lib_exports2));
            ...
            return (0, ue.jsxs)("div", {
              ...
              children: [
                (0, ue.jsx)("a", {
                  ...
                  children: (0, ue.jsx)(re, {}),
                }),
                n2 &&
                  (0, ue.jsx)("a", {
                    className: ie()("ktl-logo-large-module_version-tag_4KEoG"),
                    href: e3,
                    target: "_blank",
                    children: n2,
                  }),
          ...
          const ce = "Solutions",
            de = "Multiplatform Mobile",
            fe = "/lp/mobile/",
            he = "Server-side",
            ve = "/lp/server-side/",
            pe = "Web frontend",
            me = "/docs/js-overview.html",
            ge = "Multiplatform for other platforms",
            _e = "/docs/multiplatform.html",
            be = "Data science",
            Ee = "/docs/data-science-overview.html",
            we = "Android",
            xe = "/docs/android-overview.html",
            ye = "Docs",
            Te = "/docs/home.html",
            Oe = "Community",
            Se = "/community/",
                ...
                (s2.items =
                  null !==
                    (l2 =
                      null == i2
                        ? void 0
                        : i2.map(({ title: r3, url: o3 }) => {
                            o3 && t3 && (o3 = Ve(o3, t3, !!n2));
                            let i3 = e3(o3, t3);
                            return (
                              i3 && (u2 = i3),
                              { title: r3, url: o3, isActive: i3 }
                            );
                          })) && void 0 !== l2
                    ? l2
                    : []),
          ...
          const Ye = ({
              ...
              return (0, ue.jsx)("ul", {
                className: ie()(
                  ...
                  o2("rs-text-2"),
                  {
                    "ktl-horizontal-menu-module_dropdown-menu-expanded_3s42o":
                      t3,
                    "ktl-horizontal-menu-module_dropdown-menu-align-right_2u7Cp":
                      n2,
                  },
                ),
                children: e3.map((e4, t4) => {
                  const n3 = !e4.isActive && e4.url ? "a" : "span";
                  return (0, ue.jsx)(
                    "li",
                    {
                      children: (0, ue.jsx)(n3, {
                        className: ie()(
                          "ktl-horizontal-menu-module_dropdown-menu-item_3DA-o",
                          {
                            "ktl-horizontal-menu-module_active_ZEjqF":
                              e4.isActive,
                          },
                        ),
                        ...(e4.url
            ...
            Xe = ({
              ...
              var s2, u2;
              const a2 = e3.isActive || !e3.url ? "span" : "a",
                c2 = (0, le.useTextStyles)();
              return (0, ue.jsxs)("li", {
                ...
                children: [
                  (0, t2.createElement)(
                    a2,
                    {
                      ...
                      className: ie()(
                        ...
                        c2("rs-text-2"),
                        {
                          "ktl-horizontal-menu-module_item-active_1JHeo":
                            e3.isActive,
                          "ktl-horizontal-menu-module_expanded_3BdiD":
                            o2 &&
                            !(
                              null === (s2 = e3.items) ||
                              void 0 === s2 ||
                  ...
                  !(null === (u2 = e3.items) || void 0 === u2 || !u2.length) &&
                    (0, ue.jsx)(Ye, {
                      items: e3.items,
                      isExpanded: o2,
                      alignRight: i2,
            ...
            Ke = ({ items: e3, theme: n2, linkHandler: r2 }) => {
              const [o2, i2] = (0, t2.useState)(-1),
                [l2, s2] = (0, t2.useState)(o2);
              (0, t2.useEffect)(() => {
                const e4 = setTimeout(() => s2(o2), -1 !== o2 ? 200 : 400);
                return () => clearTimeout(e4);
              }, [o2]);
              const u2 = (t3) => i2(e3.findIndex((e4) => e4 === t3)),
                a2 = () => i2(-1);
              return (0, ue.jsx)("nav", {
                className: ie()("ktl-horizontal-menu-module_nav_19XiR", {
                  "ktl-horizontal-menu-module_dark-theme_3x53H": "dark" === n2,
                }),
                children: (0, ue.jsx)("ul", {
                  className: "ktl-horizontal-menu-module_menu-list_3f1cp",
                  children: e3.map((t3, n3) =>
                    (0, ue.jsx)(
                      Xe,
                      {
                        item: t3,
          ...
          const Je = ({ onClick: e3, isActive: t3 }) =>
            (0, ue.jsx)("button", {
              type: "button",
              className: ie()("ktl-search-button_button_2B8BX", {
                "ktl-search-button_active_2TUDV": t3,
              }),
              "aria-label": "Search",
              onClick: e3,
              children: (0, ue.jsx)($e, {}),
          ...
          var rt = function (e3) {
            return t2.createElement(
              ...
              et ||
                (et = t2.createElement("path", {
                  fillRule: "evenodd",
                  clipRule: "evenodd",
                  d: "M15.707 1.707L14.293.293 8 6.586 1.707.293.293 1.707 6.586 8 .293 14.293l1.414 1.414L8 9.414l6.293 6.293 1.414-1.414L9.414 8l6.293-6.293z",
                  fill: "currentColor",
                })),
            );
          };
          const ot = ({ onClick: e3, isExpanded: t3 }) =>
            (0, ue.jsx)("button", {
              type: "button",
              className: ie()("ktl-menu-button_button_olcOe"),
              "aria-haspopup": "true",
              "aria-label": "Open the navigation",
              onClick: e3,
              children: t3 ? (0, ue.jsx)(rt, {}) : (0, ue.jsx)(tt, {}),
            });
          function it(e3) {
            if (Array.isArray(e3)) {
          ...
          var ut =
            ...
            vt = function (e3) {
              return at.some(function (t3) {
                return !(
                  !t3.options.allowTouchMove || !t3.options.allowTouchMove(e3)
                );
              });
            },
            pt = function (e3) {
              ...
              return (
                !!vt(t3.target) ||
                t3.touches.length > 1 ||
                (t3.preventDefault && t3.preventDefault(), false)
              );
            },
            mt = function () {
              setTimeout(function () {
                (void 0 !== ht &&
                  ((document.body.style.paddingRight = ht), (ht = void 0)),
                  void 0 !== ft &&
                    ((document.body.style.overflow = ft), (ft = void 0)));
              });
            },
            gt = function (e3, t3) {
              if (ut) {
                ...
                if (
                  ...
                  ((at = [].concat(it(at), [n2])),
                    (e3.ontouchstart = function (e4) {
                      1 === e4.targetTouches.length &&
                        (dt = e4.targetTouches[0].clientY);
                    }),
                    (e3.ontouchmove = function (t4) {
                      1 === t4.targetTouches.length &&
                        (function (e4, t5) {
                          var n3 = e4.targetTouches[0].clientY - dt;
                          !vt(e4.target) &&
                            ((t5 && 0 === t5.scrollTop && n3 > 0) ||
                            ((function (e5) {
                              return (
                                !!e5 &&
                                e5.scrollHeight - e5.scrollTop <=
                                  e5.clientHeight
                              );
                            })(t5) &&
                              n3 < 0)
                ...
                !(function (e4) {
                  if (void 0 === ht) {
                    var t4 = !!e4 && true === e4.reserveScrollBarGap,
                      n3 =
                        window.innerWidth -
                        document.documentElement.clientWidth;
                    t4 &&
                      n3 > 0 &&
                      ((ht = document.body.style.paddingRight),
                      (document.body.style.paddingRight = n3 + "px"));
                  }
                  void 0 === ft &&
                    ((ft = document.body.style.overflow),
                    setTimeout(function () {
          ...
          const _t = ({ item: e3, level: n2, linkHandler: r2 }) => {
              const o2 = e3.url ? "a" : "span",
                i2 = { "--level": n2 },
                l2 = (0, t2.useCallback)(
                  (t3) => r2 && e3.url && r2(t3, e3.url),
                  [],
                );
              return (0, ue.jsx)(o2, {
                ...(e3.url ? { href: e3.url, onClick: l2 } : {}),
                className: ie()("ktl-menu-popup-module_menu-item_1F_5T", {
                  "ktl-menu-popup-module_menu-item-root_3IeHg": 0 === n2,
                  "ktl-menu-popup-module_active_oy808": e3.isActive,
                  "ktl-menu-popup-module_active-with-child_1hc8s":
                    e3.items && e3.items.length,
                }),
                style: i2,
                children: e3.title,
              });
            },
            bt = ({ items: e3, level: n2, linkHandler: r2 }) =>
              (0, ue.jsx)(ue.Fragment, {
                children: e3.map((e4, o2) =>
                  (0, ue.jsxs)(
                    t2.Fragment,
                    {
                      children: [
            ...
            Et = ({
              ...
              const l2 = (0, t2.useRef)(null),
                s2 = (0, le.useTextStyles)(),
                [u2, a2] = (0, t2.useState)({});
              ((0, t2.useEffect)(
                () => () => {
                  (r2(false),
                    ut
                      ? (at.forEach(function (e4) {
                          ((e4.targetElement.ontouchstart = null),
                            (e4.targetElement.ontouchmove = null));
                        }),
                        ct &&
                ...
                (0, t2.useLayoutEffect)(() => {
                  o2.current &&
                    a2({ top: o2.current.getBoundingClientRect().bottom });
                }, [n2, o2]));
                  ...
                  (n2
                    ? (function (e4) {
                        if (ut) {
                          ...
                          ((e4.ontouchstart = null),
                            (e4.ontouchmove = null),
                            (at = at.filter(function (t3) {
              ...
              return (0, ue.jsxs)(ue.Fragment, {
                children: [
                  (0, ue.jsx)(ot, { onClick: c2, isExpanded: n2 }),
                  (0, ue.jsx)("nav", {
                    style: u2,
                    ref: l2,
                    className: ie()(
                      "ktl-menu-popup-module_menu-popup_2xTwR",
                      s2("rs-text-2"),
                      { "ktl-menu-popup-module_menu-popup-expanded_1OBoJ": n2 },
                    ),
                    children: (0, ue.jsx)(bt, {
                      items: e3,
                      level: 0,
                      linkHandler: i2,
                    }),
            ...
            return t2.createElement(
              ...
              wt ||
                (wt = t2.createElement(
                  ...
                  t2.createElement("stop", { offset: 1, stopColor: "#7f52ff" }),
                )),
              xt ||
                (xt = t2.createElement("path", {
          ...
          const Ot = ({ homeTitle: e3, homeUrl: t3, className: n2 }) => {
            ...
            return (0, ue.jsxs)("div", {
              className: ie()("ktl-logo-small-module_logo-small_qYr7I", n2),
              children: [
                (0, ue.jsx)("a", {
                  href: se,
                  className: "ktl-logo-small-module_icon-wrap_3Osc0",
                  children: (0, ue.jsx)(Tt, {
                    className: "ktl-logo-small-module_icon_3SINU",
                  }),
                }),
                (0, ue.jsx)("a", {
                  href: t3,
                  className: ie()(
                    "ktl-logo-small-module_link__2NeW",
                    r2("rs-h3"),
                  ),
                  children: e3,
                }),
          ...
          var St = (0, t2.forwardRef)(
            (
              ...
              const [v2, p2] = (0, t2.useState)(false),
                [m2, g2] = (0, t2.useState)(false),
                _2 = (0, t2.useMemo)(() => We(f2, o2, d2), [f2, o2, d2]),
                b2 = (0, t2.useRef)(null);
              return (
                (0, t2.useImperativeHandle)(h2, () => b2.current),
                (0, t2.useLayoutEffect)(() => {
                  var e4, t3, n3;
                  g2(
                    (null !==
                      (e4 =
                        null === (t3 = b2.current) ||
                        void 0 === t3 ||
                        null === (n3 = t3.getBoundingClientRect) ||
                        void 0 === n3
                          ? void 0
                          : n3.call(t3).width) && void 0 !== e4
                      ? e4
                      : 0) <= 640,
                  );
                }, [b2]),
                Q(b2, (e4) => g2(e4.contentRect.width <= 640)),
                (0, ue.jsx)(i.ThemeProvider, {
                  theme: "dark",
                  children: (0, ue.jsxs)("header", {
                    ref: b2,
                    className: ie()("ktl-header-module_header-menu_3q6JB", s2, {
                      "ktl-header-module_with-menu-popup_191Ak": v2,
                      "ktl-header-module_border_3kxUB": u2,
                    }),
                    children: [
                      m2 && l2 && o2 && !v2
                        ? (0, ue.jsx)(Ot, { homeTitle: l2, homeUrl: o2 })
                        : (0, ue.jsx)(ae, { productWebUrl: e3 }),
                      !m2 &&
                        (0, ue.jsx)(Ke, {
                          items: _2,
                          theme: a2,
                      ...
                      (0, ue.jsx)(Je, { onClick: r2, isActive: n2 && !!r2 }),
                      m2 &&
                        (0, ue.jsx)(Et, {
                          items: _2,
                          setExpand: p2,
